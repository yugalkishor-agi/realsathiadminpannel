...
export default function DataExplorer({ permissions }) {
  ...
  return <><div className="section-title"><div><h2>Data explorer</h2><p>View operational data available to your account.</p></div><button className="ghost-btn" onClick={reload}>Refresh</button></div>
