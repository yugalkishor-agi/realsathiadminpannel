...
val debugDirectChatUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/chat/messages", "direct-chat")
...
val debugBlockUserUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/report/block", "block-user")
val debugUnblockUserUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/report/unblock", "unblock-user")
val debugListBlockedUsersUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/report/blocked", "list-blocked-users")
val debugListUserReportsUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/report/reports", "list-user-reports")
...
val debugSubmitFeedbackUrl = authEndpoint(debugBaseUrl, debugAuthMode, "v1/feedback", "submit-feedback")
...
val releaseDirectChatUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/chat/messages", "direct-chat")
...
val releaseBlockUserUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/report/block", "block-user")
val releaseUnblockUserUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/report/unblock", "unblock-user")
val releaseListBlockedUsersUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/report/blocked", "list-blocked-users")
val releaseListUserReportsUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/report/reports", "list-user-reports")
...
val releaseSubmitFeedbackUrl = authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/feedback", "submit-feedback")
...
android {
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "DIRECT_CHAT_URL", "\"$debugDirectChatUrl\"")
            ...
            buildConfigField("String", "BLOCK_USER_URL", "\"$debugBlockUserUrl\"")
            buildConfigField("String", "UNBLOCK_USER_URL", "\"$debugUnblockUserUrl\"")
            buildConfigField("String", "LIST_BLOCKED_USERS_URL", "\"$debugListBlockedUsersUrl\"")
            buildConfigField("String", "LIST_USER_REPORTS_URL", "\"$debugListUserReportsUrl\"")
        ...
        buildConfigField("String", "RECORD_WALLET_TRANSACTION_URL", "\"$debugRecordWalletTransactionUrl\"")
            buildConfigField("String", "CALL_EVENTS_URL", "\"${authEndpoint(debugBaseUrl, debugAuthMode, "v1/calling/events", "call-events")}\"")
            ...
            buildConfigField("String", "SUBMIT_FEEDBACK_URL", "\"$debugSubmitFeedbackUrl\"")
        ...
        release {
            ...
            buildConfigField("String", "DIRECT_CHAT_URL", "\"$releaseDirectChatUrl\"")
            ...
            buildConfigField("String", "BLOCK_USER_URL", "\"$releaseBlockUserUrl\"")
            buildConfigField("String", "UNBLOCK_USER_URL", "\"$releaseUnblockUserUrl\"")
            buildConfigField("String", "LIST_BLOCKED_USERS_URL", "\"$releaseListBlockedUsersUrl\"")
            buildConfigField("String", "LIST_USER_REPORTS_URL", "\"$releaseListUserReportsUrl\"")
        ...
        buildConfigField("String", "RECORD_WALLET_TRANSACTION_URL", "\"$releaseRecordWalletTransactionUrl\"")
            buildConfigField("String", "CALL_EVENTS_URL", "\"${authEndpoint(releaseBaseUrl, releaseAuthMode, "v1/calling/events", "call-events")}\"")
            ...
            buildConfigField("String", "SUBMIT_FEEDBACK_URL", "\"$releaseSubmitFeedbackUrl\"")
