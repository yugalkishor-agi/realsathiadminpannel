package com.incoteam.frndzz.core.session
...
import com.incoteam.frndzz.data.model.auth.UserSession
...
class SessionManager(context: Context) {
    ...
    companion object {
        private const val PREFS_NAME = "frndzz_session"
    ...
    private fun profileNeedsSetup(profile: RemoteUserProfile?): Boolean {
        ...
        return nickname.isBlank() ||
            nickname.startsWith("frndzzz_", ignoreCase = true) ||
            gender.isBlank() ||
            interests.isEmpty()
    }
