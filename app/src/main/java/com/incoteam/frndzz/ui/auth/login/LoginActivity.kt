...
import com.incoteam.frndzz.databinding.ActivityLoginBinding
import com.incoteam.frndzz.ui.auth.AuthViewModelFactory
import com.incoteam.frndzz.ui.auth.AuthLayoutTuner
import com.incoteam.frndzz.ui.auth.otp.OtpVerificationActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        binding.textTermsLink.setOnClickListener {
            openExternalPage("https://frndzz.in/terms.html")
        }
        binding.textPrivacyLink.setOnClickListener {
            openExternalPage("https://frndzz.in/privacy.html")
        }
