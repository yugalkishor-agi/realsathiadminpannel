...
object EngagementReminderScheduler {
    ...
    private const val CHANNEL_ID = "realsaathi_engagement_reminders"
    private const val CHANNEL_NAME = "RealSaathi Reminders"
    private const val CHANNEL_DESCRIPTION = "Smart reminder burst when the user comes back online."
    private const val REMINDER_ACTION = "com.incoteam.realsaathi.action.SHOW_ENGAGEMENT_REMINDER"
    ...
    private const val REMINDER_PREFS = "realsaathi_reminder_prefs"
    ...
    private val REMINDER_COPY = listOf(
        "Online aa gaye? Aaj bas net hi nahi, thoda dil bhi on kar lo. RealSaathi par koi tumhari vibe ka wait kar raha ho sakta hai.",
        "Wi-Fi on ho gaya, ab thodi si romantic feel bhi on kar do. RealSaathi par apni pasandida ladki se baat shuru karo.",
        "Raat, mood aur internet tino ready hain. RealSaathi kholo aur kisi khaas conversation ko start karo."
    )
